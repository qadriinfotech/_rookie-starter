 ...
 */
  ...
  //Slider effects
  $animated_item_1 = ro_get_option('animated_item_1');
  $animated_item_2 = ro_get_option('animated_item_2');
  $animated_item_3 = ro_get_option('animated_item_3');

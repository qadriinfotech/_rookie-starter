...
<header id="wrap">
    ...
    <nav class="navbar navbar-default navbar-main" >
        <div class="container clearfix">
            ...
            <nav id="desktop-menu" class="hidden-xs" <?php Schema_Markup::schema_metadata( array('context' => 'nav' )); ?>>
                <?php desktop_nav(); ?>             
            </nav> <!-- hidden-xs -->

            <?php if ( wp_is_mobile() ) { ?>
            <nav id="mobile-menu" class="visible-xs" <?php Schema_Markup::schema_metadata( array('context' => 'nav' )); ?>>
